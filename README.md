...
![건양대헬스케어톤X네이버_안저이미지부문_5위](C:\Users\haru5\Desktop\카카오 제출 자료\클라우드 추가자료-카카오 포트폴리오\191130_건양대헬스케어톤X네이버Clova_NSML_안저이미지부문_5위\건양대헬스케어톤X네이버_안저이미지부문_5위.jpg)

작성한 코드 내용 위주로 정리.

- 전체적인 모델 기본 구조는 다음과 같습니다.

![1588826709386](C:\Users\haru5\AppData\Roaming\Typora\typora-user-images\1588826709386.png)

- 저희가 개발한 모델의 구조는 다음과 같습니다.
  - ~~ 에서 착안하여 활용하였습니다. 

- efficientnet, mobilenet_v2, DenseNet121, ResNet50, 성능개선
- 이미지 마다 값이 전부 달랐기 때문에 레이어에 입력값을 넣기 전에 batchnormalization layer을 통과시켜서 값을 정규화해주었습니다.
